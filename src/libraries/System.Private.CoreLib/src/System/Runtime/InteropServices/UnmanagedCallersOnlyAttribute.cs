...
namespace System.Runtime.InteropServices
{
    ...
    public sealed class UnmanagedCallersOnlyAttribute : Attribute
    {
        ...
        ///
        /// The "default platform calling convention" is generally unambiguous for all supported
        /// platforms except x86-based platforms. The x86 defaults are as follows:
