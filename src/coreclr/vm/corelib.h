...
DEFINE_CLASS(UNSAFEACCESSORHELPERS, CompilerServices, UnsafeAccessorHelpers)
DEFINE_METHOD(UNSAFEACCESSORHELPERS, VERIFY_CONSTRAINTS_AT_RUNTIME, VerifyConstraintsAtRuntime, SM_RuntimeTypeHandle_RuntimeMethodHandle_RetVoid)
